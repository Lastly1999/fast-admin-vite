...
// apis
import {getAllSysMenus, putSystemMenu} from "@/services/auth"
...
<template>
    ...
    <MenuDrawerForm v-model:visible="showMenuDrawer" v-model:title="showMenuTitle" v-model:loading="menuFormloading"
                    :form="menuModalForm"
                    @submit="formSubmit"/>
</template>
